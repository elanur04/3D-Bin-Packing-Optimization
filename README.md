#  3D Bin Packing Optimization Web App
...
- ** Dinamik Parametre Ayarı:** Popülasyon boyutu, nesil sayısı, mutasyon oranı gibi algoritma parametrelerini sol menüden anında değiştirin.
...
## Cloud Deploy (Google Cloud / Streamlit Cloud)
